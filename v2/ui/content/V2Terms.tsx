      ...
      <Container pt={12} pb={16} bg="navy.900" maxW="4xl" height="full">
        ...
        <Box my={6}>
          ...
          <Text mt={2} fontSize="14px">
            ...
            or collectively with other https://sy.country
            subpages, the{' '}
            <Text as="span" fontWeight="700">
              “Website”
            </Text>
        ...
        <Box my={6}>
          ...
          <Text mt={2} fontSize="14px">
            ...
            ) to access to or participate in the SY decentralized, autonomous financial
            ...
            meaning that individual SY contributors and the SY DAO, have no ability to control,
        ...
        <Box my={6}>
          ...
          <Text mt={2} fontSize="14px">
            ...
            <UnorderedList my={4}>
              ...
              <ListItem>
                To impersonate or attempt to impersonate a specific individual SY DAO contributor,
        ...
        <Box my={6}>
          ...
          <Text mt={2} fontSize="14px">
            The terms “SY,” “1SY,” and all related names, logos, product
            and service names, designs, and slogans are trademarks of SY or its affiliates or
            licensors. You must not use such marks without the prior written permission of SY;
            ...
            (excluding the SY logo), product and service names, designs, and slogans in any way
            that they desire so long as such usage is not done in a way that: (1) is deceitful,
            fraudulent, or manipulative; (2) implies any relationship between User and SY beyond
        ...
        <Box my={6}>
          ...
          <Text mt={2} fontSize="14px">
            ...
            construed as SY’s offer to buy, sell, or exchange crypto-assets.{' '}
            <Text as="span" fontWeight="700">
            ...
            <Text mt={2}>
              ...
              (without limitation) materials provided by SY DAO Contributors, bloggers, blockchain
              ...
              through official SY channel, are solely the opinions and the responsibility of the
              person or entity providing those materials. These materials do not necessarily reflect
              the opinion of individual SY contributors or even the factual status of reality. We
        ...
        <Box my={6}>
          ...
          <Text mt={2} fontSize="14px">
            SY DAO is a developer of open-source software and does not unilaterally offer, operate,
            ...
            <Text mt={2}>
              ...
              EXTENT LEGALLY PERMISSIBLE, NEITHER WE, NOR ANY PERSON ASSOCIATED WITH SY, MAKE, AND
              ...
              NON-INFRINGEMENT, AND FITNESS FOR A PARTICULAR PURPOSE. NEITHER SY NOR ANY PERSON
              ASSOCIATED WITH SY MAKES ANY WARRANTY OR REPRESENTATION WITH RESPECT TO THE
              COMPLETENESS, SECURITY, RELIABILITY, QUALITY, ACCURACY, OR AVAILABILITY OF THE
              WEBSITE, THE INTERFACE, OR THE SERVICES. SY AND ANY PERSON ASSOCIATED WITH SY DO NOT
        ...
        <Box my={6}>
          ...
          <Text mt={2} fontSize="14px">
            TO THE FULLEST EXTENT PROVIDED BY LAW, IN NO EVENT WILL SY DAO, ITS AFFILIATES, OR
            ...
            WILL THE COLLECTIVE LIABILITY OF SY AND ITS SUBSIDIARIES AND AFFILIATES, AND THEIR
            ...
            THE GREATER OF $100 OR THE AMOUNT YOU HAVE PAID DIRECTLY TO SY FOR THE APPLICABLE
        ...
        <Box my={6}>
          ...
          <Text mt={2} fontSize="14px">
            ...
            relied on SY, the content on the Website, the Interface, or the Services for any
        ...
        <Box my={6}>
          ...
          <Text mt={2} fontSize="14px">
            ...
            SY DAO contributors never take possession, custody, control, ownership, or management
        ...
        <Box my={6}>
          ...
          <Text mt={2} fontSize="14px">
            The User agrees to defend, indemnify, and hold harmless SY, its affiliates, licensors,
        ...
        <Box my={6}>
          ...
          <Text mt={2} fontSize="14px">
            No waiver by SY of any term or condition set out in these Terms of Use shall be deemed
            a further or continuing waiver of such term or condition or a waiver of any other term
            or condition, and any failure of SY to assert a right or provision under these Terms of
        ...
        <Box my={6}>
          ...
          <Text mt={2} fontSize="14px">
            ...
            herein constitute the sole and entire agreement between the User and SY regarding the
